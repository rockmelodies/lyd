        ...
        <div class="custom" style="border:1px solid #A1AEAF; box-shadow:2px 2px 2px 2px #cccccc; border-radius:9px;background:#495391;overflow:hidden;color:#fff; ">
          <div style="background:#178d27;height: 80px;text-align:center;">
           ...
           <div class="" style="width:95% !important; float:left; margin-left:15px">
			...
			<div class="form-item" style="width:100px; vertical-align:top; margin:50px 30px 0px 0px; float:left;">
				<input type="radio" name="payment_method" id="payment_method_1" value="wire_transfer" checked onClick="$('#unionpay_payment').hide();$(credit_card_payment).hide();$('#wire_transfer_payment').show();$('#paypal_payment').hide();$('#payment_form').validationEngine('hide');">Wire Transfer
			</div>
			<!--<div class="form-item" style="width:150px; vertical-align:top; margin:50px 30px 0px 0px; float:left;">
				<input type="radio" name="payment_method" id="payment_method_2" value="credit_card" onClick="$('#unionpay_payment').hide();$('#credit_card_payment').show();$('#wire_transfer_payment').hide();$('#paypal_payment').hide();$('#payment_form').validationEngine('hide');">Visa/Master Card 
			</div>-->
			<!--<div class="form-item" style="width:150px; vertical-align:top; margin:50px 30px 0px 0px; float:left;">
				<input type="radio" name="payment_method" id="payment_method_3" value="paypal" onClick="$('#unionpay_payment').hide();$('#credit_card_payment').hide();$('#wire_transfer_payment').hide();$('#paypal_payment').show();$('#payment_form').validationEngine('hide');">PayPal 
			</div>-->
			...
			<div id="paypal_payment" style="display:none;margin:20px;">
			<form name="paypal_checkout" id="paypal_checkout"  method="post" action="process_payment.php">
